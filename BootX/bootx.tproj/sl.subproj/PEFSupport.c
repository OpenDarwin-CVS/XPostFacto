...
rptPart2:															
	...
	*theData = (LogicalAddress) originalUnpackBuffer;
							...
							ByteCount		theSymbolSize)
{
	...
	SectionHeaderPtr			loaderSectionPtr = NULL;	// Pointer to the Loader Section Header
