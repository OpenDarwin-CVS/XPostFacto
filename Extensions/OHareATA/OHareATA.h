...
#ifndef _DRV_OHARE_ATA_H
#define _DRV_OHARE_ATA_H
...
/*! @class OHareATA : public MacIOATA
    @abstract The specific driver for ohare-ata controllers.
    @discussion class contains all of the code specific to matching and
    running ohare ata controllers.

*/    

class OHareATA : public MacIOATA
{
    OSDeclareDefaultStructors(OHareATA)
...
public:
	...
	// checks for the compatible property of "ohare-ata" 
	// in the device tree.
