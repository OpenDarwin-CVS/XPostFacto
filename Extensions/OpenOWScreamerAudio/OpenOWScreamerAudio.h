...
#ifndef __OPENOWSCREAMERAUDIO_H__
#define __OPENOWSCREAMERAUDIO_H__
...
class OpenOWScreamerAudio : public IOAudioDevice
{
    OSDeclareDefaultStructors(OpenOWScreamerAudio);
