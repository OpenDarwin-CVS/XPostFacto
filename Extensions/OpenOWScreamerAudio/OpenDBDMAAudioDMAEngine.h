#ifndef _OPENDBDMAAUDIODMAENGINE_H
#define _OPENDBDMAAUDIODMAENGINE_H
...
class OpenDBDMAAudioDMAEngine : public IOAudioEngine
{
    OSDeclareDefaultStructors(OpenDBDMAAudioDMAEngine)
...
protected:
    ...
    static bool			iSubEnginePublished (OpenDBDMAAudioDMAEngine * dbdmaEngineObject, void * refCon, IOService * newService);
...
#endif /* _OPENDBDMAAUDIODMAENGINE_H */
