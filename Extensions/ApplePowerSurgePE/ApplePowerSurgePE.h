...
#ifndef _APPLE_POWERSURGE_PE_H
#define _APPLE_POWERSURGE_PE_H

#include <IOKit/platform/ApplePlatformExpert.h>

class ApplePowerSurgePE : public ApplePlatformExpert
{
	OSDeclareDefaultStructors(ApplePowerSurgePE);
