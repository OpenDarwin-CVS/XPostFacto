...
#ifndef _IOKIT_OPENPMUPCCARDEJECT_H
#define _IOKIT_OPENPMUPCCARDEJECT_H

class OpenPMUPCCardEject : public IOPCCardEjectController
{
    OSDeclareDefaultStructors(OpenPMUPCCardEject)
...
#endif /* ! _IOKIT_OPENPMUPCCARDEJECT_H */
